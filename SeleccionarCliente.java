...
public class SeleccionarCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Selección de Cliente Miembro");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Buscar Cliente Miembro"));
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        if (cliente != null) {
            ...
            frameAnterior.activarQuitarArticulo(true);
            this.dispose();
        } else {
