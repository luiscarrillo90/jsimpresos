...
INSERT INTO `cortesdecaja` VALUES (1,'2015-08-06 17:44:50'),(2,'2015-08-17 07:02:49'),(3,'2015-08-17 08:11:41'),(4,'2015-08-17 08:21:36'),(5,'2015-08-18 04:49:19'),(6,'2015-08-18 05:05:06'),(7,'2015-08-18 17:11:36'),(8,'2015-08-22 07:56:35'),(9,'2016-04-27 03:17:03');
...
--
-- Table structure for table `transaccionesmascotas`
--

DROP TABLE IF EXISTS `transaccionesmascotas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `transaccionesmascotas` (
  `idUsuario` int(11) NOT NULL,
  ...
  KEY `idCorte` (`idCorte`),
  CONSTRAINT `transaccionesmascotas_ibfk_1` FOREIGN KEY (`idUsuario`) REFERENCES `usuariosmascotas` (`idUsuario`),
  CONSTRAINT `transaccionesmascotas_ibfk_2` FOREIGN KEY (`idCorte`) REFERENCES `cortesdecaja` (`idcorte`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `transaccionesmascotas`
--

LOCK TABLES `transaccionesmascotas` WRITE;
/*!40000 ALTER TABLE `transaccionesmascotas` DISABLE KEYS */;
/*!40000 ALTER TABLE `transaccionesmascotas` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-04-27  9:51:12
